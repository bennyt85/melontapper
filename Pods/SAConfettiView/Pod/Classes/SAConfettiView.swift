...
public class SAConfettiView: UIView {
    ...
    func imageForType(_ type: ConfettiType) -> UIImage? {
        ...
        let path = Bundle(for: SAConfettiView.self).pathForResource("SAConfettiView", ofType: "bundle")
    ...
    func confettiWithColor(_ color: UIColor) -> CAEmitterCell {
        ...
        confetti.birthRate = 80.0 * intensity
        confetti.lifetime = 100.0 * intensity
